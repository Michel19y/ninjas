...
try {
    $tabela = 'pontos_guilda'; // Apenas a tabela Guilda
...
<head>
    ...
    <title>Tabela Ninjas Guilda</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="icon" type="image/png" href="../assets/img/guilda.png">
    <link rel="stylesheet" href="../assets/css/index.css" />
</head>
<body>
<div class="container my-4">
    <h2 class="text-center mb-4">Tabela Ninjas Guilda</h2>

    <div class="text-center mb-4">
        <a href="index.php"><img src="../assets/img/lua.png" class="link" alt="Tabela Lua"></a>
        <a href="tabela_sol.php"><img src="../assets/img/sol.png" class="link" alt="Tabela Sol"></a>
