...
try {
    $tabela = 'pontos_lua'; // Apenas a tabela Lua
...
<head>
    ...
    <title>Tabela Ninjas Lua</title>
    <link rel="icon" type="image/png" href="../assets/img/lua.png">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="../assets/css/index.css" />
</head>
<body>
<div class="container my-5">
    <h2 class="text-center mb-4">Tabela Ninjas Lua</h2>
    ...
    <div class="text-center mb-5">
        ...
        <a href="tabela_sobrevivencia.php" class="mx-2">
            <img src="../assets/img/treino.png" class="link" alt="Ninjas da Sobrevivência" width="40">
        </a>
    </div>
